  ...
  return (
    <>
      ...
      <Card style={{ margin: 20, padding: 20 }}>
        <Card.Title style={{ fontWeight: 'bold' }}>Balance Sheet</Card.Title>
        <Table striped bordered hover>
          ...
          <tbody>
            ...
            <tr style={{ backgroundColor: 'black' }}>
              ...
              <td align="right" style={{ color: 'white', fontWeight: 'bold' }}>
                {
            ...
            <tr>
              ...
              <td align="right">
                {addCommas(_.sumBy(fcClosingDetails, 'sgdValue').toFixed(2))}
              </td>
            </tr>
            <tr>
      ...
      <Card style={{ margin: 20, padding: 20 }}>
        <Card.Title style={{ fontWeight: 'bold' }}>Currency Stock</Card.Title>
        <Table striped bordered hover>
          <thead>
            <tr>
              <th>Currency Code</th>
